...
vim.api.nvim_set_hl(0, "Visual", { bg = palette.teal, fg = palette.black })
...
vim.api.nvim_set_hl(0, "CurSearch", { bg = palette.yellow, fg = palette.black })
vim.api.nvim_set_hl(0, "Search", { bg = palette.lime, fg = palette.black })
vim.api.nvim_set_hl(0, "SpellBad", { special = palette.red, undercurl = true })
vim.api.nvim_set_hl(0, "SpellCap", { special = palette.yellow, undercurl = true })
vim.api.nvim_set_hl(0, "SpellLocal", { special = palette.green, undercurl = true })
vim.api.nvim_set_hl(0, "SpellRare", { special = palette.cyan, undercurl = true })
...
vim.api.nvim_set_hl(0, "@module", { fg = palette.indigo })
vim.api.nvim_set_hl(0, "@module.builtin", { fg = palette.indigo })
vim.api.nvim_set_hl(0, "@label", { fg = palette.deep_purple })
vim.api.nvim_set_hl(0, "@string", { fg = palette.green })
...
vim.api.nvim_set_hl(0, "@lsp.type.interface", { fg = palette.lime })
vim.api.nvim_set_hl(0, "@lsp.type.lifetime", { fg = palette.teal })
vim.api.nvim_set_hl(0, "@attribute", { fg = palette.teal })
vim.api.nvim_set_hl(0, "@attribute.builtin", { fg = palette.teal })
...
vim.api.nvim_set_hl(0, "@markup.link.url", { fg = palette.blue, italic = true, underline = true })
vim.api.nvim_set_hl(0, "@markup.raw", { fg = palette.teal })
vim.api.nvim_set_hl(0, "@markup.raw.block", { fg = palette.teal })
vim.api.nvim_set_hl(0, "@markup.list", { fg = palette.blue })
...
-- nvim_cmp
vim.api.nvim_set_hl(0, "CmpItemKindText", { fg = palette.mtext })
vim.api.nvim_set_hl(0, "CmpItemKindVariable", { fg = palette.mtext })
vim.api.nvim_set_hl(0, "CmpItemKindField", { fg = palette.indigo })
vim.api.nvim_set_hl(0, "CmpItemKindFunction", { fg = palette.blue })
vim.api.nvim_set_hl(0, "CmpItemKindProperty", { fg = palette.indigo })
vim.api.nvim_set_hl(0, "CmpItemKindKeyword", { fg = palette.deep_purple })
vim.api.nvim_set_hl(0, "CmpItemKindClass", { fg = palette.yellow })
vim.api.nvim_set_hl(0, "CmpItemKindEnum", { fg = palette.orange })
